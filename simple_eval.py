    ...
    with tf.Graph().as_default():
        ...
        with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
            ...
            for filenames, images in load_images(input_dir, batch_shape):
                ...
                for filename, l1, l2, l3, l4, l5, l6, l7 in zip(filenames, v3, ens3_adv_v3,ens4_adv_v3, v4, res_v2, ens_adv_res_v2, resnet):
                    label = f2l[filename]
            ...
            for i in range(len(model_name)):
                ...
                print("{0:.1f} ".format(success_count[i] / 1000. * 100), end="")
